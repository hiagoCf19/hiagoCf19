...
- 🏢 Atuando como fullstack na **Ivy Group S/A**, desenvolvendo soluções estratégicas para os setores financeiro, varejo, agronegócio e saúde.
- ⚙️ Integrando equipes na implementação de **Arquitetura Orientada a Eventos (EDA)** com RabbitMQ para processamento em lote de alto volume.
...
- 🌱 Priorizando a organização e qualidade de código.
